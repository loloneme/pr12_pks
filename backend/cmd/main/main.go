...
import (
	"github.com/loloneme/pr12/backend"
	"github.com/loloneme/pr12/backend/internal/handler"
	"github.com/loloneme/pr12/backend/internal/logger"
	"github.com/loloneme/pr12/backend/internal/repository"
	"github.com/loloneme/pr12/backend/internal/service"
	"log/slog"
	"time"
)
